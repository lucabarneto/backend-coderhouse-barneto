const infoError = {
  ...
  noAuthStrategyErrorInfo: (argument) =>
    `ERROR: One or more authentication arguments were invalid:
  ...
  notAuthenticatedErrorInfo: () =>
    `ERROR: User was not authenticated and tried to enter a page that required authentication. User was automatically redirected to /login.`,
